...
knitr::include_graphics("https://raw.githubusercontent.com/mrmelchi/Credit_Scoring/master/Captura.PNG")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/mrmelchi/Credit_Scoring/master/SelectionVariates.png")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/mrmelchi/Credit_Scoring/master/ROC_KS.png")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/mrmelchi/Credit_Scoring/master/PSI.png")
```

PSI in our case is 0.007.

```{r fig.cap="Figure 5. Results", out.width = '90%'}
knitr::include_graphics("https://raw.githubusercontent.com/mrmelchi/Credit_Scoring/master/summary.png")
```
